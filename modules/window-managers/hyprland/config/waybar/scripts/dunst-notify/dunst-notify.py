...
unread_prefix = '<span color="' + args.color + '">' + args.prefix + '</span>'

res = subprocess.Popen("~/.config/waybar/scripts/dunst-notify/dunst-notify.sh", stdout=subprocess.PIPE, shell=True)
